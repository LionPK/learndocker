...
<div class="w3-content w3-container w3-padding-64" id="build">
  ...
  <center><img src="<?php echo base_url(); ?>assets/images/d33.PNG" alt="ไฟล์ main.go" onclick="onClick(this)" class="w3-round w3-image w3-opacity w3-hover-opacity-off"><br></center>

  <p>- Dockerfile</p>
  <center><img src="<?php echo base_url(); ?>assets/images/d34.PNG" alt="ไฟล์ dockerfile" onclick="onClick(this)" class="w3-round w3-image w3-opacity w3-hover-opacity-off" ><br></center>
  ...
  <center><img src="<?php echo base_url(); ?>assets/images/d35.PNG" alt="คำสั่ง Deploy Container" onclick="onClick(this)" class="w3-round w3-image w3-opacity w3-hover-opacity-off" ><br></center>
  ...
  <center><img src="<?php echo base_url(); ?>assets/images/d36.PNG" alt="คำสั่งเข้าไปอ่านไฟล์" onclick="onClick(this)" class="w3-round w3-image w3-opacity w3-hover-opacity-off" ><br></center>

  <center><img src="<?php echo base_url(); ?>assets/images/d37.PNG" alt="ตัวอย่างผลลัพ" onclick="onClick(this)" class="w3-round w3-image w3-opacity w3-hover-opacity-off" ><br></center>

  <p>4. Run<br>สุดท้ายเราจะสั่ง run container ที่เราสร้างขึ้นเมื่อสักครู่ด้วยคำสั่ง</p>
  <center><img src="<?php echo base_url(); ?>assets/images/d38.PNG" alt="run container" onclick="onClick(this)" class="w3-round w3-image w3-opacity w3-hover-opacity-off" ><br></center>
