...
<div class="w3-top">
  <div class="w3-bar" id="myNavbar">
    ...
    <a href="/Docker/docker" class="w3-bar-item w3-button w3-hide-small">USE DOCKER</a>
  </div>

  <!-- Navbar on small screens -->
  <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium">
    <a href="#build" class="w3-bar-item w3-button" onclick="toggleFunction()">BUILD CONTAINER</a>
    <a href="/Docker/docker" class="w3-bar-item w3-button" onclick="toggleFunction()">USE DOCKER</a>
  </div>
</div>
