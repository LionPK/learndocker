...
.bgimg-2 {
    background-image: url("<?php echo base_url(); ?>assets/images/5160.jpg");
    min-height: 400px;
}
...
<div class="bgimg-1 w3-display-container w3-opacity-min" id="home">
  <div class="w3-display-middle" style="white-space:nowrap;">
    <span class="w3-center w3-padding-large w3-black w3-xlarge w3-wide w3-animate-opacity">แนะนำการใช้งาน Docker</span>
  </div>
</div>
...
<div class="bgimg-2 w3-display-container w3-opacity-min">
  <div class="w3-display-middle">
    <center><span class="w3-xxlarge w3-text-white w3-wide">Docker Client-Server Architecture</span></center>
  </div>
</div>
...
<div class="bgimg-2 w3-display-container w3-opacity-min">
  <div class="w3-display-middle">
    <center><span class="w3-xxlarge w3-text-white w3-wide">Docker Client</span></center>
  </div>
</div>
...
<div class="bgimg-2 w3-display-container w3-opacity-min">
  <div class="w3-display-middle">
    <center><span class="w3-xxlarge w3-text-white w3-wide">Docker Daemon</span></center>
  </div>
</div>
...
<div class="w3-content w3-container w3-padding-64" id="docker_d">
  ...
  <center><img src="<?php echo base_url(); ?>assets/images/d11.PNG" class="w3-round w3-image w3-opacity w3-hover-opacity-off" alt="แบบที่ 1 CLI" width="500" height="333" onclick="onClick(this)" class="w3-hover-opacity"></center>
</div>
...
<!-- Footer -->
<footer class="w3-center w3-gray w3-padding">
  <a href="#home" class="w3-button w3-light-grey"><i class="fa fa-arrow-up w3-margin-right"></i>To the top</a>
  <p class="w3-medium">© Copyright 2017, <a href="https://www.northbkk.ac.th" target="_blank"> Praneed & Sarasut</a></p>
</footer>
