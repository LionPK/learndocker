...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
  ...
  <div class=" w3-blue " id="tour">
    <div class="w3-container w3-content w3-padding-64" style="max-width:800px">
      ...
      <p class="w3-opacity w3-center"><i>ส่วนนี้เป็นเนื้อเรื่องเกี่ยวกับ Docker ของเว็ปอื่น ๆ</i></p><br>
  ...
  <div class="w3-container w3-content w3-padding-64" style="max-width:800px" id="hub">
    ...
    <div class="w3-row w3-padding-32">
      ...
      <div class="w3-col m6">
        <img src="<?php echo base_url(); ?>assets/images/hub.png" class="w3-round w3-image" alt="hub">
      </div>
    </div>
  </div>
